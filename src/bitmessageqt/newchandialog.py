...
class Ui_newChanDialog(object):
    def setupUi(self, newChanDialog):
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.SpanningRole, self.groupBoxCreateChan)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.SpanningRole, self.groupBoxJoinChan)
        ...
        self.radioButtonCreateChan.setEnabled(True)
        self.radioButtonCreateChan.setChecked(False)
        self.radioButtonCreateChan.setObjectName(_fromUtf8("radioButtonCreateChan"))
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.radioButtonCreateChan)
        self.radioButtonJoinChan = QtGui.QRadioButton(newChanDialog)
        self.radioButtonJoinChan.setEnabled(True)
        self.radioButtonJoinChan.setChecked(True)
        self.radioButtonJoinChan.setObjectName(_fromUtf8("radioButtonJoinChan"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.radioButtonJoinChan)
    ...
    def retranslateUi(self, newChanDialog):
        ...
        self.groupBoxCreateChan.setTitle(_translate("newChanDialog", "quick + simple join   or   Create a chan", None))
        ...
        self.groupBoxJoinChan.setTitle(_translate("newChanDialog", "Join a chan tediously with addr. entry", None))
        ...
        self.radioButtonCreateChan.setText(_translate("newChanDialog", "Simply &join   or   Create a new chan  ", None))
        self.radioButtonJoinChan.setText(_translate("newChanDialog", "&Tediously join a chan with addr. ", None))
