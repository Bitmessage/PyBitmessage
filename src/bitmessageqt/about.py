...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.label_2.setText(_translate("aboutDialog", "<html><head/><body><p>Copyright &copy; 2012-2017 Jonathan Warren<br/>Copyright &copy; 2013-2017 The Bitmessage Developers</p></body></html>", None))
