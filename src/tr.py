...
class translateClass:
    ...
    def arg(self, argument):  # pylint: disable=unused-argument
        ...
        if '%' in self.text:
            # This doesn't actually do anything with the arguments because we don't
            # have a UI in which to display this information anyway.
    ...
    if enableGUI:
        try:
            ...
            print (
                ...
                ' You can download PyQt from http://www.riverbankcomputing.com/software/pyqt/download   or by'
                ' searching Google for \'PyQt Download\'. If you want to run in daemon mode, see'
