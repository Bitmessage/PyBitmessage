...
# This is used so that the translateText function
# can be used when we are in daemon mode and not
# using any QT functions.
class translateClass:
    ...
    def arg(self, argument):
        if '%' in self.text:
            ...
            # the arguments because we don't have a UI in
            # which to display this information anyway.
