...
# Uncomment these next four lines to create new deterministic addresses.
#passphrase = 'non-secure-pass'.encode('base64')
...
# Uncomment this next line to print(the first deterministic address that would be generated with the given passphrase.
#   - This will NOT add it to the Bitmessage interface or the keys.dat file.
#print(api.getDeterministicAddress('non-secure-pass'.encode('base64'), 4, 1))

# Uncomment this line to subscribe to an address. (You must use your own address, this one is invalid.)
#print(api.addSubscription('2D94G5d8yp237GGqAheoecBYpdehdT3dha', 'test sub'.encode('base64')))

# Uncomment this line to unsubscribe from an address.
...
# Uncomment this next line to decode the actual message data in the first message:
#print(inboxMessages['inboxMessages'][0]['message'].decode('base64'))

# Uncomment this next line in the code to delete a message
#print(api.trashMessage('584e5826947242a82cb883c8b39ac4a14959f14c228c0fbe6399f73e2cba5b59'))

# Uncomment these lines to send a message. The example addresses are invalid; you will have to put your own in.
#import time
...
# Uncomment these lines to send a broadcast. The example address is invalid; you will have to put your own in.
