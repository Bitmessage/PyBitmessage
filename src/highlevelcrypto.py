...
def sign(msg, hexPrivkey):
    ...
    # FIXME: SHA1 -- insecure
    return makeCryptor(hexPrivkey).sign(msg, digest_alg=OpenSSL.EVP_ecdsa)

    # TODO: SHA256. We should switch to this eventually.
...
def verify(msg, sig, hexPubkey):
    ...
    try:
        # FIXME: SHA1 -- insecure
        sigVerifyPassed = makePubCryptor(hexPubkey).verify(sig, msg, digest_alg=OpenSSL.EVP_ecdsa)
    except:
